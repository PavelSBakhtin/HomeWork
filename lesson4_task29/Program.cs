...
{
    Console.Write(msg);
    int number = int.Parse(Console.ReadLine()); // конструкция ??"0" нивелирует ошибку NULL
    return number;
}
...
int min = ReadData("Enter the MIN value of the array: ");
int max = ReadData("Enter the MAX value of the array: ");
